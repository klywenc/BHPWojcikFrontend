...
const IncidentAddModal = ({categories, departments, locations, directors, onClose, onIncidentAdded}) => {
    ...
    const [severity, setSeverity] = useState('ZWYKLY');
                        ...
                        <div className="modal-body">
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <select id="add-categoryId" className="form-select" value={categoryId}
                                ...
                                <div className="col-md-6 mb-3">
                                    ...
                                    <select id="add-departmentId" className="form-select" value={departmentId}
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <select id="add-locationId" className="form-select" value={locationId}
                                ...
                                <div className="col-md-6 mb-3">
                                    ...
                                    <select id="add-severity" className="form-select" value={severity}
                            ...
                            <div className="mb-3">
                                <label htmlFor="add-responsiblePersonId" className="form-label">Osoba odpowiedzialna
                                    (Dyrektor)</label>
                                <select id="add-responsiblePersonId" className="form-select" value={responsiblePersonId}
                                        onChange={(e) => setResponsiblePersonId(e.target.value)}>
                                    <option value="">-- Brak --</option>
                                    {directors.map(dir => <option key={dir.id}
                                                                  value={dir.id}>{dir.name} ({dir.email})</option>)}
                                </select>
                            </div>
                            <div className="mb-3">
                                <label htmlFor="photos" className="form-label">Dodaj zdjęcia (opcjonalnie)</label>
                                <input type="file" id="photos" className="form-control" multiple
                                       onChange={handleFileChange}/>
                            </div>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" onClick={onClose}
                                    disabled={isSubmitting}>Anuluj
                            </button>
